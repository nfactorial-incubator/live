      ...
      <div className="grid grid-cols-2 gap-5 mb-6">
        {projects?.length > 0 ? (
          projects.map((project) => (
            <div className="flex flex-col border bg-white rounded-md p-6 transform transition-transform ease-in-out duration-100 hover:border-gray-300 hover:-translate-y-1 focus:-translate-y-1">
              <div>🚀🦾</div>
